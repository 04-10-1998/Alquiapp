...
import 'package:integradora/administrador/src/data/cart/cart_in_memory_repository.dart';
import 'package:integradora/administrador/src/data/products/product_in_memory_repository.dart';
import 'package:integradora/administrador/src/domain/cart/cart_repository.dart';
import 'package:integradora/administrador/src/domain/cart/usecases/add_product_to_cart_use_case.dart';
import 'package:integradora/administrador/src/domain/cart/usecases/edit_quantity_of_cart_item_use_case.dart';
import 'package:integradora/administrador/src/domain/cart/usecases/get_cart_use_case.dart';
import 'package:integradora/administrador/src/domain/cart/usecases/remove_item_to_from_use_case.dart';
...
import 'package:integradora/administrador/src/presentation/cart/cart_presenter.dart';
import 'package:integradora/administrador/src/presentation/products/products_presenter.dart';
